...
def mostrar_detalhes_usuario(event):
    index = listbox_usuarios.curselection()
    if index:
        index = int(index[0])
        usuario = usuarios[index]
        ...
        detalhes_janela.title('Detalhes do Usuário')

        tk.Label(detalhes_janela, text=f"ID: {usuario['ID']}", font=("Arial", 12)).pack(pady=5)
        tk.Label(detalhes_janela, text=f"Nome: {usuario['Nome']}", font=("Arial", 12)).pack(pady=5)
        tk.Label(detalhes_janela, text=f"Telefone: {usuario['Telefone']}", font=("Arial", 12)).pack(pady=5)
        tk.Label(detalhes_janela, text=f"Endereço: {usuario['Endereço']}", font=("Arial", 12)).pack(pady=5)
...
listbox_usuarios.bind("<Double-1>", mostrar_detalhes_usuario)
